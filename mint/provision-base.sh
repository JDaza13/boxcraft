#!/usr/bin/env bash
# ============================================================
#  provision-base.sh — system packages for Linux Mint 21
...
#
#  Mint 21 = Ubuntu 22.04 (jammy) base. Docker has no official
#  Mint repo so we pin the Ubuntu base codename explicitly.
# ============================================================
set -euo pipefail
